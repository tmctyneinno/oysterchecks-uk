...
class IdentityController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            $applicantRecord = Applicant::where(['user_id' =>  $validatedData['applicant_id']])->get();
            ...
            foreach ($validatedData['documents'] as $document) {
                ...
                $applicantData = $this->baseUrl->addDocument(
                    ...
                    [
                        ...
                        "middleName" => $applicantRecord['middleName'] ?? '', 
                        "issuedDate" => $applicantRecord['issueddate'] ?? '',
                        "number" => $applicantRecord['documentNumber'] ?? '',
                        "validUntil" => $applicantRecord['validUntil'] ?? '',
                        "dob" => $applicantRecord['dataofBirth'] ?? '',
                        "placeOfBirth" => $applicantRecord['placeOfBirth'] ?? '',
                    ],
                );
