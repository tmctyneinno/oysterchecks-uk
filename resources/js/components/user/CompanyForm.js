            ...
            <form onSubmit={handleSubmit} className="add-individual-form">
                <div className="card-body">
                    <div className="row">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" style={{ fontWeight:500 }}>Registration Number</label> 
                        ...
                        <div class="col-md-6">
                            <label class="form-label" style={{fontWeight:500}}>Company Email</label> 
                        ...
                        <div class="col-md-6">
                            <label class="form-label" style={{fontWeight:500}}> Company Phone number</label> 
                        ...
                        <div class="col-md-6">
                            <label class="form-label" style={{fontWeight:500}}>Created Date</label> 
                        ...
                        <div className="col-md-6">
                            <label className="form-label" style={{ fontWeight: 500 }}>Company type </label>
                            <select value={formData.companyType} onChange={onChange} className="select2 form-control mb-3 custom-select" id="companyType" name="companyType" style={{ width: '100%', height: '36px' }}>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" style={{ fontWeight: 500 }}>Taxpayer registration number</label>
                            <input type="text" value={formData.taxpayer} onChange={onChange}  id="taxpayer" name="taxpayer" class="form-control mb-3 custom-select" placeholder="Taxpayer number" />
                        </div>
                        <div className="col-md-6">
                        ...
                        <div class="col-md-12">
                            <label class="form-label mt-2" style={{ fontWeight: 500 }}>Company website</label>
                            <input type="text" value={formData.websitelink} onChange={onChange}  id="websitelink" name="websitelink" class="form-control mb-3 custom-select" placeholder="Website link" />
                        </div>
