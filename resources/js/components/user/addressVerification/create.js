            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 class="page-title">Address Verification</h4>
                                <ol class="breadcrumb">
...
if (document.getElementById('createAddressverification')) {
    ReactDOM.render(<AddressVerification />, document.getElementById('createAddressverification'));
}
