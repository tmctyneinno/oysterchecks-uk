    ...
    return (
        <div>
                        ...
                        <div className="col-md-12 col-lg-6">
                            <div className="hero-slider-content text-white">
                                ...
                                <div className="action-btns mt-3">
                                    <a href="{{route('login')}}" className="btn secondary-solid-btn">Get Started Now</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-12 col-lg-6">
                    ...
                    <div class="row justify-content-around">
                        <div class="col-md-12 col-lg-6">
                            <div class="about-img-wrap">
                                <img src="/landing_assets/fontpage2.png" width="400px" alt="video" class="img-fluid rounded shadow-sm color-bip shadow"/>
            ...
            <section class="about-us-section gray-light-bg ptb-100" style={{ background: "#fff no-repeat center center / cover"}}>
                <div class="container">
                    <div class="row justify-content-around">
                        <div class="col-md-12 col-lg-6">
                            <div class="about-img-wrap">
                                <img src="/landing_assets/fontpage2.png" alt="video" class="img-fluid rounded shadow-sm"/>
            ...
            <section class="call-to-action "
             style={{background: "url('/landing_assets/img/cta-bg.svg')no-repeat center center / cover"}}>
                <div class="container">
                    ...
                    <div className="row justify-content-around align-items-center">
                        ...
                        <div className="col-md-4">
                            <div className="action-btn text-lg-right text-sm-left">
                                <a href="#" className="btn secondary-solid-btn">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
...
if (document.getElementById('industry')) {
    ReactDOM.render(<Industry/>, document.getElementById('industry')); 
}
