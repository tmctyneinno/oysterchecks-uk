            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" id="pdfContent">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                @if($tin_verification->status == 'pending')
                                ...
                                @elseif($tin_verification->status == 'found')
                                <div class="alert custom-alert alert-success icon-custom-alert shadow-sm fade show d-flex justify-content-between" role="alert">
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            <h5 class="mb-1 fw-bold mt-0 text-success">Tax Information Found</h5>
                                ...
                                <div class="alert custom-alert alert-danger icon-custom-alert shadow-sm fade show d-flex justify-content-between" role="alert">
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            <h5 class="mb-1 fw-bold mt-0 text-danger">Tax Information Not Found</h5>
                                            <span>You provided an invalid Tax Identification number</span>
                                        </div>
                                    </div>
                                </div>
                                @endif
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="my-4 d-flex justify-content-between align-items-center">
                                    <h4 class="fw-semibold text-dark font-16">Business (Tax ID) Report - {{$tin_verification->ref}}</h4>
                                    <div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8 text-break">{{$tin_verification->ref}}</div>
                                    </div>
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Initiated At:</div>
                                        <div class="font-14 col-8">{{date('jS F Y, h:iA', strtotime($tin_verification->requested_at))}}</div>
                                    </div>
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="py-3 px-4 bg-light">
                                    <h2 class="font-16 m-0 lh-base">Company/Tax Information</h2>
                                </div>
                            </div>
                            @if($tin_verification->status == 'found')
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8">
                                            {{$tin_verification->name}}
                                        </div>
                                    </div>
                        
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Company Registration Number:</div>
                                        <div class="font-14 col-8">{{$tin_verification->registration_number}}</div>
                                    </div>
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                    ...
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8">
                                            {{$tin_verification->jtb_tin}}
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Tax Office:</div>
                                        <div class="font-14 col-8">{{$tin_verification->tax_office}}</div>
                                    </div>
                                   
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Email Address:</div>
                                        <div class="font-14 col-8">{{$tin_verification->email}}</div>
                                    </div>
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Phone Number:</div>
                                        <div class="font-14 col-8">{{$tin_verification->phone}}</div>
                                    </div>
                                </div>
                            </div>
                            @elseif($tin_verification->status == 'not_found')
                                <div class="row mt-5">
                                    <div class="col-12 col-sm-9 col-md-6 ms-auto me-auto text-center align-items-center">
                                        
                                        <h5 class="card-title mb-5 text-muted">You Searched for "{{$tin_verification->search_value}}"</h5>
                                        ...
                                        <a href="{{route('showIdentityVerificationForm', $tin_verification->type)}}" class="btn btn-primary btn-sm mt-4 mb-3">Make another request</a>
                                    </div>
                                </div>
                            @else
