                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card report-card">
                            <div class="card-body" >
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        <p class="text-black mb-0 fw-semibold">Verified Applicants</p>
                                   ...
                                   <div class="row">
                                       <div class="col-lg-3 ">
                                            ...
                                            <ul class="list-unstyled personal-detail mb-0">
                                                @if($appli->firstName)
                                                    <li class="mt-2"> <i class="ti ti-world text-secondary font-16 align-middle me-2"></i> <b> Applicant Name</b> : 
                                                    </li>
                                                    <li><i class="text-secondary font-16 align-middle me-4"></i>{{$appli->firstName}} {{$appli->middleName}} {{$appli->lastName}}</li>
                                                @elseif($appli->applicant_type == 'company')
                                                    <li class="mt-2"> <i class="ti ti-world text-secondary font-16 align-middle me-2"></i> <b> Company Name</b> : 
                                                    </li> 
                                                    <li><i class="text-secondary font-16 align-middle me-4"></i>{{$appli->companyname}}</li>
                                                @endif
