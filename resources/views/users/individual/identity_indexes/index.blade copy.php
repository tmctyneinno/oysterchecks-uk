        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="row">
                        <div class="col">
                            <h4 class="page-title">{{strtoupper($slug)}} Verification</h4>
                            <ol class="breadcrumb">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card report-card">
                            <div class="card-body" >
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        <p class="text-black mb-0 fw-semibold">Failed {{$slug}}  verifications</p>
            ...
            <div class="col-lg-12">
                <div class="card mb-3" style="background: #1b4c89;">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card-body">
                                <h4 class="text-white">  <strong> Verify an Identity </strong> Daniel </h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-hover dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                <td class="px-0 py-0"><a class="table-link" href=""><div class="px-2 py-3">111233</div></a></td>
                                <td class="px-0 py-0"><a class="table-link" href=""><div class="px-2 py-3">refqwe12</div></a></td>
                                <td class="px-0 py-0"><a class="table-link" href=""><div class="px-2 py-3">found or N/A </div></a></td>
                                ...
                                <td class="px-0 py-0"><a class="table-link" href=""><div class="px-2 py-3">{{auth()->user()->name}}</div></a></td>
