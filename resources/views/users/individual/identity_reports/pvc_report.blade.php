            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" id="pdfContent">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                @if($pvc_verification->status == 'pending')
                                ...
                                @elseif($pvc_verification->status == 'found')
                                @if($pvc_verification->validations != null && $pvc_verification->all_validation_passed == false)
                                <div class="alert custom-alert alert-warning icon-custom-alert shadow-sm fade show d-flex justify-content-between" role="alert">
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            <h5 class="mb-1 fw-bold mt-0 text-warning">PVC Found but Not Validated</h5>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="my-4 d-flex justify-content-between align-items-center">
                                    <h4 class="fw-semibold text-dark font-16">Identity (PVC) Report - {{$pvc_verification->ref}}</h4>
                                    <div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8 text-break">{{$pvc_verification->ref}}</div>
                                    </div>
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Initiated At:</div>
                                        <div class="font-14 col-8">{{date('jS F Y, h:iA', strtotime($pvc_verification->requested_at))}}</div>
                                    </div>
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                        ...
                        <div class="row mt-3">
                            ...
                            @if($pvc_verification->status == 'found')
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8">
                                            {{$pvc_verification->first_name}}
                                            @if(isset($pvc_verification->validations->data->firstName))
                                            @if($pvc_verification->validations->data->firstName->validated == true)
                                            <span class="ms-2 badge bg-success">Validated</span>
                                            @else
                                            <span class="ms-2 font-12 text-info" style="text-decoration: line-through;">{{$pvc_verification->validations->data->firstName->value}}</span>
                                            <span class="ms-3 badge bg-danger">Not a match</span>
                                            @endif
                                            @endif
                                        </div>
                                    </div>
                                    @if($pvc_verification->middle_name != null)
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Middle Name:</div>
                                        <div class="font-14 col-8">{{$pvc_verification->middle_name}}</div>
                                    </div>
                                    @endif
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Last Name:</div>
                                        <div class="font-14 col-8">
                                            {{$pvc_verification->last_name}}
                                            @if(isset($pvc_verification->validations->data->lastName))
                                            @if($pvc_verification->validations->data->lastName->validated == true)
                                            <span class="ms-2 badge bg-success">Validated</span>
                                            @else
                                            <span class="ms-2 font-12 text-info" style="text-decoration: line-through;">{{$pvc_verification->validations->data->lastName->value}}</span>
                                            <span class="ms-3 badge bg-danger">Not a match</span>
                                            @endif
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8">
                                            {{date('jS F Y', strtotime($pvc_verification->dob))}}
                                            @if(isset($pvc_verification->validations->data->dateOfBirth))
                                            @if($pvc_verification->validations->data->dateOfBirth->validated == true)
                                            <span class="ms-2 badge bg-success">Validated</span>
                                            @else
                                            <span class="ms-2 font-12 text-info" style="text-decoration: line-through;">{{$pvc_verification->validations->data->dateOfBirth->value}}</span>
                                            <span class="ms-3 badge bg-danger">Not a match</span>
                                            @endif
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8">{{$pvc_verification->pin}}</div>
                                    </div>
                                   
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Country:</div>
                                        <div class="font-14 col-8">{{$pvc_verification->country}}</div>
                                    </div>
                                </div>
                            </div>
                            

                            @if($pvc_verification->data_validation == true || $pvc_verification->selfie_validation == true)
                            @if($pvc_verification->all_validation_passed == false)
                            ...
                            <div class="col-auto mt-3">
                                <div class="alert alert-warning border-0 font-15" role="alert">
                                    {{$pvc_verification->validations->validationMessages}}
                                </div>
                            </div>
                            @endif
                            @endif
                            @elseif($pvc_verification->status == 'not_found')
                                <div class="row mt-5">
                                    <div class="col-12 col-sm-9 col-md-6 ms-auto me-auto text-center align-items-center">
                                        
                                        <h5 class="card-title mb-5 text-muted">You Searched for "{{$pvc_verification->pin}}"</h5>
                                        ...
                                        <a href="{{route('showIdentityVerificationForm', $pvc_verification->type)}}" class="btn btn-primary btn-sm mt-4 mb-3">Make another request</a>
                                    </div>
                                </div>
                            @else
