                            ...
                            <div class="row">
                                <div class="col-lg-4 ">
                                    ...
                                    <ul class="list-unstyled personal-detail mb-0">
                                        ...
                                        @endif 
                                        @if( $data['applicant']->gender)
                                        <li class="mt-2"><i class="ti ti-map text-secondary font-16 align-middle me-2"></i> <b> Gender </b> :{{ $data['applicant']->gender}} </li>
                                        @endif  
                                ...
                                <div class="col-lg-4 ">
                                    ...
                                    <ul class="list-unstyled personal-detail mb-0">
                                        ...
                                        <li class="mt-2"> <i class="ti ti-world text-secondary font-16 align-middle me-2"></i> <b> ExternalUserId</b> : {{ $data['identityVerificationdetails']->externalUserId}}</li>
                                        <li class="mt-2"><i class="ti ti-mobile me-2 text-secondary font-16 align-middle"></i> <b> Phone </b> : {{$data['identityVerificationdetails']->phone}}</li>
                                        <li class="mt-2"><i class="ti ti-email text-secondary font-16 align-middle me-2"></i> <b> Email </b> : {{ $data['identityVerificationdetails']->email}}</li>
