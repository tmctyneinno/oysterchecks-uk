                ...
                <tr bgcolor="#ffffff">
                    <td style="padding:20px 30px 20px 30px;">
                        <table align="center" style="width: 100%; max-width: 800px;">
                            ...
                            <tr><td style=" font-weight: 400; font-size: 15px;">We have created your account with details you below.</td></tr>
                            ...
                            <tr><td style="font-weight: 400; font-size: 15px;">Login Here: <span> <a href="{{route('login')}}"> Login Here </a></span></td></tr>
