                    ...
                    <tbody>
                        <tr>
                            <td class="px-3 px-sm-5 pt-3 pt-sm-5 pb-3" style="padding-bottom: 16px !important;padding-top: 44px !important;padding-right: 44px !important;padding-left: 44px !important;">
                                <h2 class="email-heading" style="font-size: 18px;color: #303e67;font-weight: 600;margin: 0;line-height: 1.4;">Welcome {{$data['firstname']}}</h2>
                            </td>
                        </tr>
                        <tr>
                            <td class="px-3 px-sm-5 pb-2" style="padding-bottom: 12px !important;padding-right: 44px !important;padding-left: 44px !important;">
                                ...
                                <p style="margin-top: 0;margin-bottom: 16px;">Thank you for creating an account with the number one background checks, KYC and AML platform in Nigeria.</p>
                                ...
                                <p style="margin: 0 !important;">Username: <span><strong>{{$data['email']}}</strong></span></p>
                        ...
                        <tr>
                            <td class="px-3 px-sm-5 pt-4" style="padding-top: 24px !important;padding-right: 44px !important;padding-left: 44px !important;">
                                ...
                                <a href="https://oysterchecks.com/login" class="link-block" style="color:#303e67;word-break:break-all;display:block">https://oysterchecks.com/login</a>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="text-center pt-4" style="text-align: center !important;padding-top: 24px !important;">
                                ...
                                <p class="email-copyright-text" style="font-size: 12px;margin: 0;padding: 0;">Copyright © {{date('Y')}} Oysterchecks. All rights reserved. <br> 1, Adeola Adeoye Street, Off Toyin Street, Ikeja, Lagos State.</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
