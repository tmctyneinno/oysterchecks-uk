...
class ApplicantController extends Controller
{
    ...
    private function sendToApi($request)
    {
     ...
     protected function createSignature($request, int $ts, $dataToSend): string
     {


        $hash = hash_hmac('sha256', $ts . strtoupper($request->method()) . $request->url() . $dataToSend, "kQYTcpGXGoQmdcY73Hr6UJOl0QjEoFJ1");
        return $hash;
     }
