...
class ApplicantController extends Controller
{
    ...
    private function sendToApi($validData)
    {
       // $apiEndpoint = $this->ReqUrl()."applicants";
        ...
        $apiResponse = $this->makeApiRequest(RequestInterface $request$apiEndpoint, $dataToSend);
        return $apiResponse;
    } 
    ...
    private function makeApiRequest(RequestInterface $request, $apiEndpoint, $dataToSend)
    {
       ...
       // Generate timestamp
        ...
        $headers = [
            ...
            "X-App-Access-Sig:".$this->createSignature($request, $now),
            "X-App-Access-Ts: $now"
        ];
