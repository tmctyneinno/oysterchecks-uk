...
class HomeController extends Controller
{
    ...
    public function fetchInsect(){
        try {
            ...
            // Get the current timestamp in seconds since Unix Epoch in UTC
            $timestamp = time();
            ...
            ->post('https://api.sumsub.com/resources/accessTokens?userId=JamesBond007&levelName=basic-kyc-level&ttlInSecs=600', [
                'key' => 'value',
