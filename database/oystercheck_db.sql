...
CREATE TABLE `adverse_media` (
  ...
  `weightedScore` varchar(255) DEFAULT NULL,
...
CREATE TABLE `applicants` (
  ...
  `applicantKey` text DEFAULT NULL,
...
(90, '2', 'not verified', '66c75eeb692fcd5b7ff21e19', '66c75eea4b8e7', 'GVBRNAYKKDHZAJ', '66c75eeb692fcd5b7ff21e19', 'fnbuKGNMGLCJgZ3y7cZVFV10GoVVZ9Y2', 'individual', '', 'Wynne', 'Bolton', 'Hu Lara', 'tahykijynu@mailinator.com', '', '67', '', '', '', 'Isle of Man', '', 'F', '', '', NULL, NULL, '', '{\"firstName\":\"Wynne\",\"firstNameEn\":\"Wynne\",\"middleName\":\"Hu Lara\",\"middleNameEn\":\"Hu Lara\",\"lastName\":\"Bolton\",\"lastNameEn\":\"Bolton\",\"dob\":\"1987-03-26\",\"gender\":\"F\",\"placeOfBirth\":\"Ullam esse ducimus\",\"placeOfBirthEn\":\"Ullam esse ducimus\",\"countryOfBirth\":\"Gibraltar\",\"stateOfBirth\":\"Ullam esse ducimus\",\"companyInfo\":{\"companyName\":\"\",\"registrationNumber\":\"\",\"country\":\"Isle of Man\",\"type\":\"individual\",\"email\":\"\",\"phone\":\"\",\"website\":\"\"}}', '{\"companyName\":\"\",\"registrationNumber\":\"\",\"country\":\"Isle of Man\",\"type\":\"individual\",\"email\":\"\",\"phone\":\"\",\"website\":\"\"}', '{\"reviewId\":\"RvKaU\",\"attemptId\":\"XopFZ\",\"attemptCnt\":0,\"levelName\":\"basic-kyc-level\",\"levelAutoCheckMode\":null,\"createDate\":\"2024-08-22 15:53:15+0000\",\"reviewStatus\":\"init\",\"priority\":0}', NULL, '2024-08-22 14:53:14', '2024-08-22 14:53:14'),
(91, '2', 'not verified', '66c9ec928426f21d59edf178', '66c9ec9168956', 'GVBRNAYKKDHZAJ', '66c9ec928426f21d59edf178', 'fnbuKGNMGLCJgZ3y7cZVFV10GoVVZ9Y2', 'individual', '', 'Reagan', 'Hooper', 'Aiko Summers', 'qaryv@mailinator.com', '', '731234535', '', '', '', 'Albania', '', 'F', '', '', NULL, NULL, '', '{\"firstName\":\"Reagan\",\"firstNameEn\":\"Reagan\",\"middleName\":\"Aiko Summers\",\"middleNameEn\":\"Aiko Summers\",\"lastName\":\"Hooper\",\"lastNameEn\":\"Hooper\",\"dob\":\"1987-11-06\",\"gender\":\"F\",\"placeOfBirth\":\"Aliqua Voluptatum v\",\"placeOfBirthEn\":\"Aliqua Voluptatum v\",\"countryOfBirth\":\"Christmas Island\",\"stateOfBirth\":\"Aliqua Voluptatum v\",\"companyInfo\":{\"companyName\":\"\",\"registrationNumber\":\"\",\"country\":\"Albania\",\"type\":\"individual\",\"email\":\"\",\"phone\":\"\",\"website\":\"\"}}', '{\"companyName\":\"\",\"registrationNumber\":\"\",\"country\":\"Albania\",\"type\":\"individual\",\"email\":\"\",\"phone\":\"\",\"website\":\"\"}', '{\"reviewId\":\"BVZHu\",\"attemptId\":\"WoGab\",\"attemptCnt\":0,\"levelName\":\"basic-kyc-level\",\"levelAutoCheckMode\":null,\"createDate\":\"2024-08-24 14:22:10+0000\",\"reviewStatus\":\"init\",\"priority\":0}', NULL, '2024-08-24 13:22:10', '2024-08-24 13:22:10');
...
CREATE TABLE `applicant_sandbox` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `applicantId` int(11) DEFAULT NULL,
  `reviewAnswer` varchar(255) DEFAULT NULL,
  `rejectLabels` varchar(255) DEFAULT NULL,
  `reviewRejectType` varchar(255) DEFAULT NULL,
  `clientComment` varchar(255) DEFAULT NULL,
  `moderationComment` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `applicant_verifications`
--
...
CREATE TABLE `applicant_verifications` (
  ...
  `fixedInfo` varchar(255) DEFAULT NULL,
  `companyInfo` text DEFAULT NULL,
  `requiredIdDocs` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `changing_top_level_info` (
  ...
  `questionnaires` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `custom_applicant_tags` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `applicantId` int(11) DEFAULT NULL,
  `custom_tags` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `field_inputs` (
  ...
  `is_required` varchar(255) DEFAULT NULL,
  `label` varchar(255) DEFAULT NULL,
  `inputid` varchar(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `identity_verifications` (
  ...
  `country` varchar(255) DEFAULT NULL,
  `idDocType` varchar(255) DEFAULT NULL,
  `idDocSubType` varchar(255) DEFAULT NULL,
  `firstName` varchar(255) DEFAULT NULL,
  `lastName` varchar(255) DEFAULT NULL,
  `middleName` varchar(255) DEFAULT NULL,
...
INSERT INTO `identity_verifications` (`id`, `user_id`, `applicantId`, `sourceKey`, `externalUserId`, `content`, `country`, `idDocType`, `idDocSubType`, `firstName`, `lastName`, `middleName`, `issuedDate`, `validUntil`, `docNumber`, `dob`, `placeOfBirth`, `imageID`, `fee`, `created_at`, `updated_at`) VALUES
(1, '2', '66c75eeb692fcd5b7ff21e19', NULL, NULL, 'identityDocuments/3XfpYaBOhHHMuSBh1YbQ7qXEgjQbdFBqC0JzRX1r.png', 'United Kingdom', 'ID Card', 'null', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1551264088', '5000', '2024-08-24 11:03:54', '2024-08-24 11:03:54'),
(2, '2', '66c75eeb692fcd5b7ff21e19', NULL, NULL, 'identityDocuments/zLeRlJgwvto08fCkBfIwwqIydzskhuLjqtqQVZHn.png', 'GBR', 'ID Card', 'null', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '690477012', '5000', '2024-08-24 12:04:17', '2024-08-24 12:04:17'),
(3, '2', '66b58a2cf7d7e4104cfa7b9b', NULL, NULL, 'identityDocuments/upxsqI32sjChScFcmdh76OlGIzm7ZcmjHsyCrRkr.png', 'GBR', 'ID Card', 'null', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1857030764', '5000', '2024-08-24 12:06:46', '2024-08-24 12:06:46'),
(4, '2', '66b583b534fdbb0305d76128', NULL, NULL, 'identityDocuments/dzr7C7ds4yVegNAGIWJcAFODqfPuoQ0hGFNDDzvv.png', 'NGA', 'ID Card', 'null', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1883507721', '5000', '2024-08-24 12:07:56', '2024-08-24 12:07:56'),
(5, '2', '66b58a2cf7d7e4104cfa7b9b', NULL, NULL, 'identityDocuments/rQiYAuCpy3H32Lk5HtaXgj7BirapkUzL3N8zauyO.png', 'DZA', 'Passport', 'null', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '742728602', '5000', '2024-08-24 12:11:16', '2024-08-24 12:11:16'),
(6, '2', '66c75eeb692fcd5b7ff21e19', NULL, NULL, 'identityDocuments/PebVmVkM7CqJSdvbNFQ6Oh68hQVYue2PIKL6LHte.png', 'AFG', 'ID Card', 'null', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1076733045', '5000', '2024-08-24 12:17:59', '2024-08-24 12:17:59'),
(7, '2', '66c75eeb692fcd5b7ff21e19', NULL, NULL, 'identityDocuments/VgVBYJe4wvLbIC3SABPZTleWfh0wlBDpKWmV7fKC.png', 'AFG', 'ID Card', 'null', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1547136682', '5000', '2024-08-24 12:18:13', '2024-08-24 12:18:13'),
(8, '2', '66c75eeb692fcd5b7ff21e19', NULL, NULL, 'identityDocuments/R43XY0f1qQqCK2Z3gtF7FEDBEEz45Sf7qCaNa7kq.png', 'GBR', 'Passport', 'null', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '113351878', '5000', '2024-08-24 12:18:15', '2024-08-24 12:18:15');
...
(29, '2024_05_13_111139_create_applicant_verifications_table', 24),
(30, '2024_05_15_165731_create_identity_verification_table', 24);
...
CREATE TABLE `resetting_signle_verification_step_` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `applicantId` int(11) DEFAULT NULL,
  `idDocSetType` varchar(255) DEFAULT NULL,
  ...
  `applicant_data` varchar(255) DEFAULT NULL,
  `identity` varchar(255) DEFAULT NULL,
  `identity2` varchar(255) DEFAULT NULL,
  `identity3` varchar(255) DEFAULT NULL,
  `identity4` varchar(255) DEFAULT NULL,
  `proof_of_residence` varchar(255) DEFAULT NULL,
  `selfie` varchar(255) DEFAULT NULL,
  `selfie2` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `applicant_verifications`
--
ALTER TABLE `applicant_verifications`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `applicant_verifications`
--
ALTER TABLE `applicant_verifications`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
